    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-primary" href="http://hospitalnew.bdtask.com/demo6/department"> <i class="fa fa-list"></i>  Department List </a>  
                </div>
            </div> 
            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <form action="../SaveServlet" class="form-inner" method="post" accept-charset="utf-8">
                                                                                                                            <input type="hidden" name="csrf_stream_token" value="90d41f72584a3a89d1128017e983fd77" />

                            
<input type="hidden" name="dprt_id" value="" />

                            <div class="form-group row">
                                <label for="name" class="col-xs-3 col-form-label">Department Name <i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input name="name"  type="text" class="form-control" id="name" placeholder="Department Name" value="">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <textarea name="description" class="form-control"  placeholder="Description" rows="7"></textarea>
                                </div>
                            </div>
