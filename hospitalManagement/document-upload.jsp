...
<html lang="en">
    <head>
        ...
        <title>Dashboard - Add Document</title>
    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail"> 
            ...
            <div class="panel-heading">
                <div class="btn-group">
                    <a class="btn btn-success" href="http://hospitalnew.bdtask.com/demo6/patient/document"> <i class="fa fa-list"></i>  Document List </a>  
                </div>
            </div>
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-12">
                        ...
                        <form action="http://hospitalnew.bdtask.com/demo6/patient/document_form" class="form-inner" id="mailForm"  enctype="multipart/form-data" method="post" accept-charset="utf-8">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="patient_id"  type="text" class="form-control" id="patient_id" placeholder="Patient ID" value="">
                                </div>
                            </div>
...
$(function(){
    ...
    browseFile.on('change',function(e)
    {
        ...
        $.ajax({
            url      : 'http://hospitalnew.bdtask.com/demo6/patient/do_upload',
