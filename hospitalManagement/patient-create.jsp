    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-primary" href="http://hospitalnew.bdtask.com/demo6/patient"> <i class="fa fa-list"></i>  Patient List </a>  
                </div>
            </div> 
            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <form action="http://hospitalnew.bdtask.com/demo6/patient/create" class="form-inner" enctype="multipart/form-data" method="post" accept-charset="utf-8">
...
<option value="AB-">AB-</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <div class="form-check">
                                        ...
                                        <label class="radio-inline">
                                        <input type="radio" name="sex" value="Other"  >Other                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <textarea name="address" class="form-control"  placeholder="Address" maxlength="140" rows="7"></textarea>
                                </div>
                            </div> 
