    ...
    <div class="col-sm-12">
        <div class="panel panel-default thumbnail">
            ...
            <div class="panel-heading">
                <div class="btn-group">
                    <a class="btn btn-success" href="http://hospitalnew.bdtask.com/demo6/patient/document_form"> <i class="fa fa-plus"></i>  Add Document </a>  
                </div>
            </div>
            ...
            <div class="panel-body"> 
                ...
                <table width="100%" class="datatable table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                                    ...
                                    <td>This is demo documents</td>
                                    <td>2017-12-19</td> 
                                    <td>Jhon Doe</td> 
                                    <td class="center" width="80">
                                        <a target="_blank" href="http://hospitalnew.bdtask.com/demo6/./assets/attachments/1a6b1585635477665ba44dd09ae4f0c0.png" class="btn btn-xs btn-info"><i class="fa fa-eye"></i></a>
                                        <a download href="http://hospitalnew.bdtask.com/demo6/./assets/attachments/1a6b1585635477665ba44dd09ae4f0c0.png" class="btn btn-xs btn-success"><i class="fa fa-download"></i></a>
                                        <a href="http://hospitalnew.bdtask.com/demo6/patient/document_delete/1?file=./assets/attachments/1a6b1585635477665ba44dd09ae4f0c0.png" class="btn btn-xs btn-danger" onclick="return confirm('Are You Sure ? ') "><i class="fa fa-trash"></i></a> 
                                    </td>
                                </tr>
                                                                                            <tr>
                                    <td>2</td>
                                    ...
                                    <td>Jhon Doe</td> 
                                    <td class="center" width="80">
                                        <a target="_blank" href="http://hospitalnew.bdtask.com/demo6/./assets/attachments/d91dffec0441558d4e1ec88be2af0ed0.jpg" class="btn btn-xs btn-info"><i class="fa fa-eye"></i></a>
                                        <a download href="http://hospitalnew.bdtask.com/demo6/./assets/attachments/d91dffec0441558d4e1ec88be2af0ed0.jpg" class="btn btn-xs btn-success"><i class="fa fa-download"></i></a>
                                        <a href="http://hospitalnew.bdtask.com/demo6/patient/document_delete/2?file=./assets/attachments/d91dffec0441558d4e1ec88be2af0ed0.jpg" class="btn btn-xs btn-danger" onclick="return confirm('Are You Sure ? ') "><i class="fa fa-trash"></i></a> 
                                    </td>
                                </tr>
                                                                                            <tr>
                                    <td>3</td>
                                    <td>P3LFN0JJ</td>
                                    <td>Dr.Mesut  Alzain</td>
                                    <td>This is demo test</td>
                                    <td>2017-12-19</td> 
                                    <td>Jhon Doe</td> 
                                    <td class="center" width="80">
                                        <a target="_blank" href="http://hospitalnew.bdtask.com/demo6/./assets/attachments/3135890f70525480ae278503f9cf26f0.jpg" class="btn btn-xs btn-info"><i class="fa fa-eye"></i></a>
                                        <a download href="http://hospitalnew.bdtask.com/demo6/./assets/attachments/3135890f70525480ae278503f9cf26f0.jpg" class="btn btn-xs btn-success"><i class="fa fa-download"></i></a>
                                        <a href="http://hospitalnew.bdtask.com/demo6/patient/document_delete/3?file=./assets/attachments/3135890f70525480ae278503f9cf26f0.jpg" class="btn btn-xs btn-danger" onclick="return confirm('Are You Sure ? ') "><i class="fa fa-trash"></i></a> 
                                    </td>
                                </tr>
                                                                                            <tr>
                                    <td>4</td>
                                    <td>P3LFN0JJ</td>
                                    <td>Dr.Ykayama Durusalaln</td>
                                    <td>This is text</td>
                                    <td>2017-12-19</td> 
                                    <td>Jhon Doe</td> 
                                    <td class="center" width="80">
                                        <a target="_blank" href="http://hospitalnew.bdtask.com/demo6/./assets/attachments/dfc7ca03d208b70869f2b2294be958e6.png" class="btn btn-xs btn-info"><i class="fa fa-eye"></i></a>
                                        <a download href="http://hospitalnew.bdtask.com/demo6/./assets/attachments/dfc7ca03d208b70869f2b2294be958e6.png" class="btn btn-xs btn-success"><i class="fa fa-download"></i></a>
                                        <a href="http://hospitalnew.bdtask.com/demo6/patient/document_delete/4?file=./assets/attachments/dfc7ca03d208b70869f2b2294be958e6.png" class="btn btn-xs btn-danger" onclick="return confirm('Are You Sure ? ') "><i class="fa fa-trash"></i></a> 
                                    </td>
                                </tr>
